...
<script type="text/javascript" src="static/js/account/employeeLogins.js"></script>
							...
							<div class="form-group">
								<div class="input-group input-group-lg">
									...
									<input type="text" class="form-control" 
										   id="adminName" name="name" placeholder="用户名">
								</div>
							...
							<div class="form-group">
								<div class="input-group input-group-lg">
									...
									<input type="password" class="form-control" 
										   id="adminPassword" name="password" placeholder="密码">
								</div>
